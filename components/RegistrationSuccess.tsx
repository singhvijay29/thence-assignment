...
const RegistrationSuccess = ({ countDown }: any) => {
  return (
    <div className="w-[718px] mx-auto flex flex-col items-center relative h-full">
      ...
      <h3 className="text-[56px] manrope-600 text-[#1C1C1C] leading-[67.2px] mb-5">
        Congratulations
      </h3>
      <div className="Manrope-500 text-[27px] leading-[35.1px] text-[#727272] text-center">
        Your request has been successfully submitted to us. We will validate
        your information and reach out to your shortly with updates
      </div>
      <div className="Manrope-400 text-[20px] text-[#727272] fixed bottom-[42px]">
